...
export function registerMasterTools(server: McpServer, client: TallyClient, state: TallyState): number {
  let count = 0;

  // ── 1. tally_create_ledger ────────────────────────────────────
  server.tool(
    'tally_create_ledger',
    'Create a new ledger (account) in TallyPrime. Supports GST registration, address, contact, credit terms.',
    {
    ...
    async (params) => {
      try {
        if (params.gstin) {
          ...
          if (!gstCheck.valid) return result({ status: 'validation_error', message: gstCheck.error });
        }
  ...
  server.tool(
    'tally_alter_ledger',
    'Modify an existing ledger — rename, change group, update GST, address, contact, credit terms.',
    {
  ...
  server.tool(
    'tally_delete_ledger',
    'Delete a ledger from TallyPrime. Only works if ledger has no transactions.',
    {
  ...
  server.tool(
    'tally_get_ledger',
    'Get complete details of a single ledger — balance, GST, address, bills, contact info.',
    {
  ...
  server.tool(
    'tally_list_ledgers',
    'List all ledgers, optionally filtered by parent group. Returns name, parent, closing balance.',
    {
  ...
  server.tool(
    'tally_create_group',
    'Create a new account group under a parent group in Tally.',
    {
  ...
  server.tool(
    'tally_alter_group',
    'Modify an existing group — rename or change parent.',
    {
  ...
  server.tool(
    'tally_delete_group',
    'Delete an account group. Must have no sub-groups or ledgers.',
    {
  ...
  server.tool(
    'tally_list_groups',
    'List all account groups in the company.',
    {},
    async () => {
      try {
        const config = {
  ...
  server.tool(
    'tally_create_stock_item',
    'Create a new stock/inventory item with unit, GST, HSN, opening stock, MRP, batch & expiry settings.',
    {
  ...
  server.tool(
    'tally_alter_stock_item',
    'Modify an existing stock item — rename, change GST/HSN, unit, MRP.',
    {
  ...
  server.tool(
    'tally_delete_stock_item',
    'Delete a stock item. Must have no transactions.',
    {
  ...
  server.tool(
    ...
    'List all stock items with GST, HSN, MRP, closing balance details.',
    {},
    async () => {
      try {
  ...
  server.tool(
    'tally_create_stock_category',
    'Create a new stock category for inventory classification.',
    {
  ...
  server.tool(
    'tally_create_unit',
    'Create a simple unit of measure — Nos, Kg, Ltrs, Pcs, etc.',
    {
  ...
  server.tool(
    'tally_create_compound_unit',
    'Create a compound unit — e.g. Box of 12 = 12 Nos.',
    {
  ...
  server.tool(
    'tally_list_units',
    'List all units of measure configured in the company.',
    {},
    async () => {
      try {
        const config = {
  ...
  server.tool(
    'tally_create_price_level',
    'Create a price level for multi-price-list management.',
    {
  ...
  server.tool(
    'tally_set_price_list',
    'Set a price for a stock item under a specific price level.',
    {
  ...
  server.tool(
    'tally_create_godown',
    'Create a new godown (warehouse/storage location).',
    {
  ...
  server.tool(
    'tally_list_godowns',
    'List all godowns/warehouses configured in the company.',
    {},
    async () => {
      try {
        const config = {
  ...
  server.tool(
    'tally_create_cost_centre',
    'Create a new cost centre for expense tracking and allocation.',
    {
  ...
  server.tool(
    'tally_create_cost_category',
    'Create a cost category for grouping cost centres.',
    {
  ...
  server.tool(
    'tally_list_cost_centres',
    'List all cost centres in the company.',
    {},
    async () => {
      try {
        const config = {
  ...
  server.tool(
    'tally_create_voucher_type',
    'Create a custom voucher type based on a standard type (Sales, Purchase, Receipt, Payment, Journal, etc.).',
    {
  ...
  server.tool(
    'tally_list_voucher_types',
    'List all voucher types (standard + custom) in the company.',
    {},
    async () => {
      try {
        const config = {
  ...
  server.tool(
    'tally_create_currency',
    'Create a new currency for multi-currency accounting.',
    {

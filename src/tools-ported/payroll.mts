...
export function registerPayrollTools(server: McpServer, client: TallyClient, state: TallyState): number {
  let count = 0;
  ...
  server.tool(
    'tally_create_employee',
    'Create an employee master in TallyPrime.',
    {
  ...
  server.tool(
    'tally_get_employee_detail',
    'Get full details of a specific employee.',
  ...
  server.tool(
    'tally_create_employee_group',
    'Create an employee group (e.g. Department, Division).',
    {
  ...
  server.tool(
    'tally_create_pay_head',
    'Create a pay head (Earnings, Deductions, Employer contributions).',
    {
  ...
  server.tool(
    'tally_list_pay_heads',
    'List all pay heads defined in the company.',
    {},
    async () => {
      try {
        const config = TDLBuilder.buildCustomCollection({
  ...
  server.tool(
    'tally_create_salary_structure',
    'Set salary structure for an employee (assign pay heads with amounts/percentages).',
    {
      employee_name: z.string().describe('Employee name'),
  ...
  server.tool(
    'tally_process_payroll',
    'Process payroll for a month — creates payroll vouchers for all/specified employees.',
    {
  ...
  server.tool(
    'tally_create_attendance_voucher',
    'Create an attendance voucher for tracking employee attendance/leave.',
    {
  ...
  server.tool(
    'tally_get_payslip',
    'Get payslip details for an employee for a given month.',
    {
      employee_name: z.string().describe('Employee name'),
  ...
  server.tool(
    'tally_get_payroll_register',
    'Get payroll register for a period — all employees, all components.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_pay_sheet',
    'Get pay sheet — compact summary of earnings/deductions for all employees.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_attendance_report',
    'Get attendance report showing days present/absent/leave for employees.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_pf_report',
    'Get Provident Fund (PF/EPF) computation report.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_esi_report',
    'Get ESI (Employee State Insurance) computation report.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_gratuity_report',
    'Get gratuity liability report for eligible employees.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_payroll_statutory_report',
    'Get consolidated statutory report: PF, ESI, PT, LWF summary.',
    dateRangeSchema,
    async (params) => {
      try {
  ...
  server.tool(
    'tally_get_ctc_report',
    'Get Cost-to-Company (CTC) report for an employee or all employees.',
    {
  ...
  server.tool(
    'tally_get_employee_ledger',
    'Get ledger-view of an employee showing all payroll transactions.',
    {
      employee_name: z.string().describe('Employee name'),
      ...dateRangeSchema,
    },
